---
article_id: TPH-09-04
title: "Proof Test Anchor: Kapan Dipertimbangkan dan Siapa Menetapkan?"
slug: "proof-test-anchor-cubicle"
description: "Explain purpose, sampling, test basis, equipment, acceptance owner, records, and failures"
status: outline
...
final_route: "/artikel/proof-test-anchor-cubicle.html"
...
# Proof Test Anchor: Kapan Dipertimbangkan dan Siapa Menetapkan?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Proof Test Anchor: Kapan Dipertimbangkan dan Siapa Menetapkan?”
- **Reader and situation:** QA/engineer team
- **Reader outcome:** Explain purpose, sampling, test basis, equipment, acceptance owner, records, and failures
...
- **Scope boundary:** No test load or acceptance value
- **Final public route:** `/artikel/proof-test-anchor-cubicle.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Proof Test Anchor: Kapan Dipertimbangkan dan Siapa Menetapkan?**.
...
- `TPH-09-03` → `/artikel/beban-kekakuan-sistem-cubicle.html` — Beban dan Kekakuan Sistem Cubicle: Apa yang Perlu Dihitung?
- `TPH-09-05` → `/artikel/kaki-cubicle-lantai-basah-waterproofing.html` — Detail Kaki Cubicle pada Lantai Basah dan Waterproofing
- `TPH-09-06` → `/artikel/koordinasi-fixing-cubicle-dengan-mep.html` — Hindari Benturan Fixing Cubicle dengan Pipa, Kabel, dan Ventilasi
...
- **Tie back to this article:** Keep the explanation specific to “Proof Test Anchor: Kapan Dipertimbangkan dan Siapa Menetapkan?”.
