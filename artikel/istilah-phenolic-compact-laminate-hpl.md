---
article_id: TPH-01-04
title: "Phenolic, Compact Laminate, dan HPL: Istilah yang Sering Tertukar"
slug: "istilah-phenolic-compact-laminate-hpl"
description: "Separate surface laminate, compact panel, substrate-backed panel, and trade labels"
status: outline
publication_date: "2025-09-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: TPH-01
primary_intent: "Clarify material names"
reader_community: "Toiletphenolic.co.id"
reader_address: "Teman Toiletphenolic.co.id"
final_route: "/artikel/istilah-phenolic-compact-laminate-hpl.html"
...
# Phenolic, Compact Laminate, dan HPL: Istilah yang Sering Tertukar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Phenolic, Compact Laminate, dan HPL: Istilah yang Sering Tertukar”
- **Reader and situation:** Specifier comparing offers
- **Reader outcome:** Separate surface laminate, compact panel, substrate-backed panel, and trade labels
- **Primary intent:** Clarify material names
...
- **Scope boundary:** No composition claim without data sheet
- **Final public route:** `/artikel/istilah-phenolic-compact-laminate-hpl.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Phenolic, Compact Laminate, dan HPL: Istilah yang Sering Tertukar**.
...
- **TOPIC-GATE:** G-01, G-03, G-04, G-05, G-06, G-08, G-09, G-10, G-13; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims.
...
- `/kelebihan-phenolic` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `TPH-01-02` → `/artikel/cubicle-partisi-bilik-ruang-toilet.html` — Cubicle, Partisi, Bilik, dan Ruang Toilet: Bedanya Apa?
- `TPH-01-03` → `/artikel/membaca-gambar-panel-pilaster-pintu-cubicle.html` — Panel, Pilaster, dan Pintu: Cara Membaca Gambar Cubicle
- `TPH-01-05` → `/artikel/tanggung-jawab-antarmuka-toilet-cubicle.html` — Siapa Bertanggung Jawab atas Panel, Struktur, Plumbing, dan Finishing?
- `TPH-01-06` → `/artikel/siklus-proyek-toilet-cubicle.html` — Dari Survei sampai Serah Terima: Siklus Proyek Toilet Cubicle
...
- **Tie back to this article:** Keep the explanation specific to “Phenolic, Compact Laminate, dan HPL: Istilah yang Sering Tertukar”.
